...
interface AnimatedThemeTogglerProps extends React.ComponentPropsWithoutRef<"button"> {
   ...
   * (e.g. a theme provider) and this component will not write to localStorage.
   */
  theme?: "light" | "dark"
...
export const AnimatedThemeToggler = ({
  ...
  // Gate theme-dependent UI on hydration: the persisted theme is only known on
  // the client, so rendering the icon/aria-pressed from it during hydration
  // would mismatch the server HTML (which always renders the light state).
  // useSyncExternalStore flips to `true` right after hydration without a
  // setState-in-effect.
